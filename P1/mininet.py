...
# This mininet connection looks like this
...
def setup_addressing(net):
    ...
    reset_macs(net, 'client2', '40:00:00:00:00:{:02x}')
    reset_macs(net, 'switch', '50:00:00:00:00:{:02x}')
    set_ip(net, 'server1','switch','192.168.100.1/24')
    set_ip(net, 'server2','switch','192.168.100.2/24')
    set_ip(net, 'client1','switch','192.168.100.3/24')
    set_ip(net, 'client2','switch','192.168.100.4/24')
